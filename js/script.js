...
// =========..........................
// SIMPLE ALERT SYSTEM (REPLACING NOTIFICATION)
// ======..........................===
...
function initializeFormNotifications() {
  ...
  form.addEventListener("submit", function (e) {
    ...
    // Simple form handling without notifications
...
function setupBookingConfirmation() {
  ...
  confirmBookingBtn.addEventListener("click", function () {
    // Get personal details first (now required)
    ...
    if (!name || !email || !phone) {
      showAlert("Please complete all personal information fields", false);
      return;
    }
    ...
    if (!checkIn || !checkOut || !roomType) {
      showAlert("Please complete all booking details", false);
      return;
    }
    ...
    const confirmationMessage =
      ...
      `has been sent to ${email}. Please check your\n` +
      `inbox (and spam folder) shortly.`;

    showAlert(confirmationMessage, true);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Initialize booking confirmation system
